...
public class buyDTO {
		...
		public String toString() {
			return "buyDTO [orderId=" + orderId + ", memberId=" + memberId + ", orderRec=" + orderRec + ", memberAddr1="
					+ memberAddr1 + ", memberAddr2=" + memberAddr2 + ", memberAddr3=" + memberAddr3 + ", orderPhone="
					+ orderPhone + ", orderDate=" + orderDate + ", shipPrice=" + shipPrice + ", totalPrice="
					+ totalPrice + ", usePoint=" + usePoint + ", getPoint=" + getPoint + ", orderState=" + orderState
					+ ", shipDate=" + shipDate + ", clearDate=" + clearDate + ", cartId=" + cartId + ", oDetail="
					+ oDetail + "]";
		}
