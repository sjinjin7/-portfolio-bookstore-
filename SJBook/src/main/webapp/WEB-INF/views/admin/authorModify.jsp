...
<script src="../resources/js/admin/authorModify.js" type="text/javascript"></script>
		...
		<div id="main_subject">
			...
			<div id="main_content_wrap">
				<div id="main_content">
					...
					<form id="authorDetail_form" method="post">
						<div id="main_content_1">
							<input type="hidden" name="authorID" value="${author.authorID}">
							<span id="main_content_1_1">작가등록</span> : <input type="text" name="authorName" value="${author.authorName}">
							<br>
							<span id="main_content_1_2">작가소개</span> :<br>
							<textarea rows="" cols="" id="authorIntro" name="authorIntro">${author.authorIntro}</textarea>
							<script>
								var ckeditor_config = {
										resize_enaleb : false,
							...
							<div id="button_wrap">
								<a href="javascript:modify_btn()">수정 완료</a>
							</div>
						</div>
					</form>
				</div>		
